package com.payment.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "paymentprocessing.controller.duration";
        ...
        try {
            ...
            Counter.builder("paymentprocessing.controller.errors")
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("paymentprocessing.service.duration",
