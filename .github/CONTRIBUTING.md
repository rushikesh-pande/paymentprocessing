# Contributing to Paymentprocessing
...
```bash
# Clone the repo
git clone https://github.com/rushikesh-pande/paymentprocessing.git
...
Open a [Discussion](https://github.com/rushikesh-pande/paymentprocessing/discussions) or
